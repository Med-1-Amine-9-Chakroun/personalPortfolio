...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="group bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer animate-fade-in"
