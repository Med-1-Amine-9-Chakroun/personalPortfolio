...
export const projects: Project[] = [
  ...
  // *********************************************
  {
    ...
    image: "/personalPortfolio/assets/DriveTn/0.png",
    images: [
      "/personalPortfolio/assets/DriveTn/0.png",
      "/personalPortfolio/assets/DriveTn/1.png",
      "/personalPortfolio/assets/DriveTn/2.png",
      "/personalPortfolio/assets/DriveTn/3.png",
      "/personalPortfolio/assets/DriveTn/4.png",
      "/personalPortfolio/assets/DriveTn/5.png",
      "/personalPortfolio/assets/DriveTn/6.jpg",
      "/personalPortfolio/assets/DriveTn/7.jpg",
      "/personalPortfolio/assets/DriveTn/8.png",
      "/personalPortfolio/assets/DriveTn/9.png",
      "/personalPortfolio/assets/DriveTn/10.png",
      "/personalPortfolio/assets/DriveTn/11.png",
      "/personalPortfolio/assets/DriveTn/12.png",
      "/personalPortfolio/assets/DriveTn/13.png",
      "/personalPortfolio/assets/DriveTn/14.png",
      "/personalPortfolio/assets/DriveTn/15.png",
      "/personalPortfolio/assets/DriveTn/16.png",
      "/personalPortfolio/assets/DriveTn/17.jpg",
      "/personalPortfolio/assets/DriveTn/18.jpg",
      "/personalPortfolio/assets/DriveTn/19.png",
      "/personalPortfolio/assets/DriveTn/20.png",
      "/personalPortfolio/assets/DriveTn/21.png",
      "/personalPortfolio/assets/DriveTn/22.png",
      "/personalPortfolio/assets/DriveTn/23.png",
      "/personalPortfolio/assets/DriveTn/24.png",
      "/personalPortfolio/assets/DriveTn/25.png",
      "/personalPortfolio/assets/DriveTn/26.png",
      "/personalPortfolio/assets/DriveTn/27.png",
      "/personalPortfolio/assets/DriveTn/28.png",
      "/personalPortfolio/assets/DriveTn/29.png",
      "/personalPortfolio/assets/DriveTn/30.jpg",
    ],
    height: "400px",
    category: "Websites",
    techStack: [
  ...
  // *********************************************
  {
    ...
    image: "/personalPortfolio/assets/Agtia/3agtia.png",
    images: [
      "/personalPortfolio/assets/Agtia/1Agtia.png",
      "/personalPortfolio/assets/Agtia/2Agtia.png",
      "/personalPortfolio/assets/Agtia/3agtia.png",
      "/personalPortfolio/assets/Agtia/4Agtia.png",
      "/personalPortfolio/assets/Agtia/5Agtia.png",
      "/personalPortfolio/assets/Agtia/6Agtia.png",
      "/personalPortfolio/assets/Agtia/7Agtia.png",
    ],
    height: "400px",
    category: "Websites",
    techStack: [
  ...
  // *********************************************
  {
    ...
    image: "/personalPortfolio/assets/DogStore/1.png",
    images: [
      "/personalPortfolio/assets/DogStore/1.png",
      "/personalPortfolio/assets/DogStore/2.png",
      "/personalPortfolio/assets/DogStore/3.png",
    ],
    height: "400px",
    category: "Mobile",
  ...
  // *********************************************
  {
    ...
    image: "/personalPortfolio/assets/GymTracker/3Gym.png",
    images: [
      "/personalPortfolio/assets/GymTracker/1Gym.png",
      "/personalPortfolio/assets/GymTracker/2Gym.png",
      "/personalPortfolio/assets/GymTracker/3Gym.png",
    ],
    category: "Websites",
    height: "400px",
    techStack: [
  ...
  // *********************************************
  {
    ...
    image: "/personalPortfolio/assets/Pharmin/1Pharmin.png",
    images: [
      "/personalPortfolio/assets/Pharmin/1Pharmin.png",
      "/personalPortfolio/assets/Pharmin/2Pharmin.png",
      "/personalPortfolio/assets/Pharmin/3Pharmin.png",
      "/personalPortfolio/assets/Pharmin/4Pharmin.png",
    ],
    category: "Websites",
    height: "400px",
...

  {
    ...
    image: "/personalPortfolio/assets/SeaMaster/1.png",
    images: [
      "/personalPortfolio/assets/SeaMaster/1.png",
      "/personalPortfolio/assets/SeaMaster/2.png",
      "/personalPortfolio/assets/SeaMaster/3.png",
      "/personalPortfolio/assets/SeaMaster/4.png",
      "/personalPortfolio/assets/SeaMaster/5.png",
      "/personalPortfolio/assets/SeaMaster/6.png",
    ],
...

  {
    ...
    image: "/personalPortfolio/assets/Rapido/2.png",

    images: [
      "/personalPortfolio/assets/Rapido/1.png",
      "/personalPortfolio/assets/Rapido/2.png",
      "/personalPortfolio/assets/Rapido/3.png",
      "/personalPortfolio/assets/Rapido/4.png",
      "/personalPortfolio/assets/Rapido/5.png",
      "/personalPortfolio/assets/Rapido/6.png",
      "/personalPortfolio/assets/Rapido/7.1.png",
      "/personalPortfolio/assets/Rapido/7.2.png",
      "/personalPortfolio/assets/Rapido/8.png",
      "/personalPortfolio/assets/Rapido/9.png",
    ],
    category: "Applications",
    height: "400px",
...

  {
    ...
    image: "/personalPortfolio/assets/OnlyCode/1.png",
    images: ["/personalPortfolio/assets/OnlyCode/1.png"],
    category: "Applications",
    height: "400px",
...

  {
    ...
    image: "/personalPortfolio/assets/PlantStore/PlantStore.png",
    images: ["/personalPortfolio/assets/PlantStore/PlantStore.png"],
    category: "Websites",
    height: "400px",
...

  {
    ...
    image: "/personalPortfolio/assets/ToDoApp/ToDoApp.png",
    images: ["/personalPortfolio/assets/ToDoApp/ToDoApp.png"],
    category: "Websites",
    height: "400px",
