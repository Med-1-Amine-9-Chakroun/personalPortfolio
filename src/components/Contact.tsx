            ...
            {[
              {
                icon: <Mail />,
                label: "Email",
                value: "chakrounmedamine19@gmail.com",
                link: "mailto:chakrounmedamine19@gmail.com",
              },
              {
                icon: <Linkedin />,
                label: "LinkedIn",
                value: "Chakroun Mohamed Amine",
                link: "https://www.linkedin.com/in/chakroun-mohamed-amine-0a32ba229/",
                target: "_blank",
              },
              {
                icon: <Phone />,
                label: "Phone",
                value: "+216 54 111 588",
                link: "tel:+1234567890",
              },
            ].map((item, index) => (
